...
public class ActivitiTest {
    ...
    private static String realPath =   
            "D:\\workspace\\activiti-demo\\src\\main\\resources\\diagrams\\";  
	
	public static void main(String[] args)  throws Exception {
		   // 创建 Activiti流程引擎  
        ProcessEngine processEngine = ProcessEngineConfiguration  
               // .createProcessEngineConfigurationFromResource("activiti.cfg.xml")  
        		.createProcessEngineConfigurationFromResource("spring-hibernate.xml")  
       ...
       // .addInputStream("DemoProcess.png", new FileInputStream(realPath + <a href="file://\\MyProcess.png">\\DemoProcess.png</a>))  
		...
		//System.out.println(processEngine.getRuntimeService().createNativeProcessInstanceQuery().count());
