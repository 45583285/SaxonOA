...
<div class="easyui-layout" data-options="fit:true">
	<div data-options="region:'east',title:'拥有权限',split:true" style="width: 200px;">
		<ul></ul>
		${sessionInfo.authNames}
	</div>
	<div data-options="region:'center',title:'基本信息'" style="overflow: hidden;padding: 5px;">
		<form method="post">
			...
			<table class="tableForm">
				...
				<tr>
					...
					<td><input readonly="readonly" value="${sessionInfo.loginNames}" /></td>
				</tr>
				<tr>
					<th>登录IP</th>
