...
$(function(){
	treegrid = $("#tt").treegrid({
			...
			pagination : false,
			frozenColumns : [ [ 
			{field : 'menuName', title : '导航名称',	width : 160}  
			] ],
		columns:[[
	...
	$("#save").on("click", function(){
			...
			title : '添加导航',
			href : '${pageContext.request.contextPath}/menusAction!toAdd.action',
			width : 540,
			height : 300,
			buttons : [ {
				text : '添加',
				handler : function() {
					var f = p.find('form');
					f.form('submit', {
						url : '${pageContext.request.contextPath}/menusAction!add.action',
						success : function(d) {
