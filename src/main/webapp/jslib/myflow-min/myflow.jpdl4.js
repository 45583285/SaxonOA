...
$.extend(true,myflow.config.props.props,{
	name : {name:'name', label:'名称', value:'123', editor:function(){return new myflow.editors.inputEditor();}},
...
$.extend(true,myflow.config.tools.states,{
	start : {
				...
				name : {text:'<<start>>'},
				text : {text:'开始'},
				img : {src : '/SaxonOA/jslib/myflow-min/img/48/start_event_empty.png',width : 48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
					ids: {name:'ids',label: 'ID', value:'', editor: function(){return new myflow.editors.inputEditor();}, value:'start'},
				...
				name : {text:'<<end>>'},
				text : {text:'结束'},
				img : {src : '/SaxonOA/jslib/myflow-min/img/48/end_event_terminate.png',width : 48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
					ids: {name:'ids',label: 'ID', value:'', editor: function(){return new myflow.editors.inputEditor();}, value:'end'},
			...
			'end-cancel' : {showType: 'image',type : 'end-cancel',
				...
				text : {text:'取消'},
				img : {src : '/SaxonOA/jslib/myflow-min/img/48/end_event_cancel.png',width : 48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
			...
			'end-error' : {showType: 'image',type : 'end-error',
				name : {text:'<<end-error>>'},
				text : {text:'错误'},
				img : {src : '/SaxonOA/jslib/myflow-min/img/48/end_event_error.png',width : 48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
			...
			state : {showType: 'text',type : 'state',
				name : {text:'<<state>>'},
				text : {text:'状态'},
				img : {src : '/SaxonOA/jslib/myflow-min/img/48/task_empty.png',width : 48, height:48},
				props : {
			...
			fork : {showType: 'image',type : 'fork',
				name : {text:'<<fork>>'},
				text : {text:'分支'},
				img : {src : '/SaxonOA/jslib/myflow-min/img/48/gateway_parallel.png',width :48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
...
/*					text: {name:'text', label: '显示', value:'', editor: function(){return new myflow.editors.textEditor();}, value:'任务'},
					...
					temp1: {name:'assignType', label : '环节', value:'', editor: function(){return new myflow.editors.selectEditor([{name:'角色',value:0},{name:'指定审批人',value:1},{name:'发起人',value:2}]);}},
					desc: {name:'desc', label : '描述', value:'', editor: function(){return new myflow.editors.inputEditor();}}*/
					/******升級到activiti5.0的修改
					 * 修改人  沈立
					 */
					ids: {name:'ids', label : 'ID', value:'', editor: function(){return new myflow.editors.inputEditor();}},
					text: {name:'text', label: '显示', value:'', editor: function(){return new myflow.editors.textEditor();}, value:'任务'},
					assignee: {name:'assignee', label: '用户', value:'', editor: function(){return new myflow.editors.inputEditor();}},
					form: {name:'form', label : '表单', value:'', editor: function(){return new myflow.editors.inputEditor();}},
					desc: {name:'desc', label : '描述', value:'', editor: function(){return new myflow.editors.inputEditor();}}
