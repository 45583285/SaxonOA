		...
		<fieldset>
			...
			<table class="table" style="width: 100%;">
				...
				<tr>
					<th>权限类型</th>
					<td>
					<select id="type" name="type" class="easyui-combobox"  style="width: 155px;">
					...
					<th>上级权限</th>
					<td>
					<input id="pid"  name="pid"  class="easyui-combotree"    data-options="valueField:'id',textField:'text',url:'${pageContext.request.contextPath}/authAction!treeGrid.action'" /> 
					</td>
				</tr>
				<tr>
					<th>权限图标</th>
					<td><input id="iconcls" name="iconcls"  class="easyui-validatebox" data-options="required:true" />
