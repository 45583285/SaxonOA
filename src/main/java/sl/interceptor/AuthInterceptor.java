...
public class AuthInterceptor extends MethodFilterInterceptor {
	...
	//	logger.info(sessionInfo.getLoginName());
	//	logger.info(sessionInfo.getAuthUrls());
		if (sessionInfo.getLoginName().equals("admin")||sessionInfo.getLoginName().equals("xuf")) {// admin用户不需要验证权限
		...
		//authUrls = "/userAction!toList.action";
		boolean b = false;
